...
import { Button, Drawer, Group, Rating, Textarea } from '@mantine/core';
    ...
    <>
      ...
      >
        ...
        <div className="flex flex-col items-center gap-4">
          ...
          <img src={interpreter.img} className="w-[144px] rounded-full" alt="interpreter" />
          <div className="text-sm text-[#686868]">{interpreter.name} · Phone Service</div>
          <Group gap={2} className="-mt-[3px] h-10">
            <Rating
              size={32}
              emptySymbol={<img src={StarOff} width={32} alt="Star Off" />}
              fullSymbol={<img src={StarOn} width={32} alt="Star On" />}
            />
          </Group>
